...
const SaturdayScreen = () => {
  const { tasks, deleteTask } = useTaskManager();
  const saturdayTasks = tasks.filter(task => task.dateday === '토요일');
  const groupedTasks = groupTasksByDate(saturdayTasks);

  return (
    <View style={styles.container}>
      <Text style={styles.title}>Saturday Schedule</Text>
      <FlatList
