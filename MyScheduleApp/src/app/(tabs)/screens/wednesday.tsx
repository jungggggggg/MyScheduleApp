...
const WednesdayScreen = () => {
  const { tasks, deleteTask } = useTaskManager();
  const wednesdayTasks = tasks.filter(task => task.dateday === '수요일');
  const groupedTasks = groupTasksByDate(wednesdayTasks);

  return (
    <View style={styles.container}>
      <Text style={styles.title}>Wednesday Schedule</Text>
      <FlatList
